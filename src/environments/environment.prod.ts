export const environment = {
    production: true,
    apiUrl: 'https://back-end-d5im.onrender.com/',
    clientId: 'BOZnI3UaXDvRFHa3tYE4EN7BIywhOZoDLofZ8zsR',
    clientSecret: 'ikUbBWILHVPVv7flR3zFYcKJMowapvsEUxN9VxiB50Bcz5BCifNAwGrxvwNIf8wLaFebzkZ9TX3nKBw5qcR9byMfiOxtQLaSkGHwlQ75SmxccWuW9sFayDiNGZVW3T5p',
    grantType: 'password',
    apiBaseUrl: 'https://back-end-d5im.onrender.com/',
    apiEndpoints: {
